...
Create a new VM instance on your cloud and select Ubuntu 24.04 as the operating system. PVM has been tested on Ubuntu 24.04.
...
```bash
# Download PVM kernel .deb files
curl -O https://pvm.exit.welteki.dev/linux-headers-6.12.33_6.12.33-g8e976d0a6d5f-1_amd64.deb
curl -O https://pvm.exit.welteki.dev/linux-image-6.12.33_6.12.33-g8e976d0a6d5f-1_amd64.deb
curl -O https://pvm.exit.welteki.dev/linux-libc-dev_6.12.33-g8e976d0a6d5f-1_amd64.deb
```
