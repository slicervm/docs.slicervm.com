...
Make sure to replace the `LICENSE` environment variable with your OpenFaaS Edge license key in the configuration section.
...
| --- | ----------- | ------ |
| LICENSE | Your OpenFaaS Edge license key | `""` |
...
# Setup OpenFaaS Edge license
sudo mkdir -p /var/lib/faasd/secrets
echo "${LICENSE}" > /var/lib/faasd/secrets/openfaas_license
